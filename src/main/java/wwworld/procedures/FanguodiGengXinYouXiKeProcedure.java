...
import wwworld.block.FanguodingBlock;
import wwworld.block.FanguodiBlock;
import wwworld.block.Caomei4Block;
import wwworld.block.CaofangkuaiBlock;
import wwworld.block.BoluoBlock;
...
public class FanguodiGengXinYouXiKeProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WwworldMod.LOGGER.warn("Failed to load dependency world for procedure FanguodiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WwworldMod.LOGGER.warn("Failed to load dependency x for procedure FanguodiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WwworldMod.LOGGER.warn("Failed to load dependency y for procedure FanguodiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WwworldMod.LOGGER.warn("Failed to load dependency z for procedure FanguodiGengXinYouXiKe!");
			return;
		}
			...
			for (int index0 = 0; index0 < (int) (50); index0++) {
				if (!(new Object() {
					...
					if ((world.getBlockState(new BlockPos((int) x, (int) (new Object() {
						...
						}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "yy")), (int) z), FanguodingBlock.block.getDefaultState(), 3);
						if (!world.isRemote()) {
							BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
							TileEntity _tileEntity = world.getTileEntity(_bp);
							BlockState _bs = world.getBlockState(_bp);
						...
						if ((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz)))).getBlock() == JishiBlock.block
								&& ((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy + 1), (int) (z + sz)))).getBlock() == Blocks.AIR
										|| (world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy + 1), (int) (z + sz))))
												.getBlock() == Blocks.CAVE_AIR)) {
							world.setBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz)), FanguodiBlock.block.getDefaultState(),
									3);
						}
						sz = (sz + 1);
					}
		...
		if (new Object() {
			...
			if (world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z)).isSolid()
					...
					&& world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1))).isSolid() && Math.random() < 0.06) {
				if (!world.isRemote()) {
					BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
					TileEntity _tileEntity = world.getTileEntity(_bp);
					BlockState _bs = world.getBlockState(_bp);
			...
			if (Math.random() < 0.7) {
				if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.CAVE_AIR
					...
					if (Math.random() < 0.01) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), Caomei4Block.block.getDefaultState(), 3);
						world.setBlockState(new BlockPos((int) x, (int) y, (int) z), CaofangkuaiBlock.block.getDefaultState(), 3);
					} else {
						if (Math.random() < 0.07) {
							world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), BoluoBlock.block.getDefaultState(), 3);
							world.setBlockState(new BlockPos((int) x, (int) y, (int) z), CaofangkuaiBlock.block.getDefaultState(), 3);
						}
					}
				}
		...
		if (new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), NituBlock.block.getDefaultState(), 3);
		}
	}
}
