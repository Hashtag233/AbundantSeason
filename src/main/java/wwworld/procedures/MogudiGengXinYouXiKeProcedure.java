...
import wwworld.block.ShaojiaodesijizhiniBlock;
import wwworld.block.ShaojiaodenituBlock;
import wwworld.block.MogudingBlock;
...
public class MogudiGengXinYouXiKeProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WwworldMod.LOGGER.warn("Failed to load dependency world for procedure MogudiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WwworldMod.LOGGER.warn("Failed to load dependency x for procedure MogudiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WwworldMod.LOGGER.warn("Failed to load dependency y for procedure MogudiGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WwworldMod.LOGGER.warn("Failed to load dependency z for procedure MogudiGengXinYouXiKe!");
			return;
		}
			...
			for (int index0 = 0; index0 < (int) (50); index0++) {
				if (!(new Object() {
					...
					if ((world.getBlockState(new BlockPos((int) x, (int) (new Object() {
						...
						}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "yy")), (int) z), MogudingBlock.block.getDefaultState(), 3);
						if (!world.isRemote()) {
							BlockPos _bp = new BlockPos((int) x, (int) y, (int) z);
							TileEntity _tileEntity = world.getTileEntity(_bp);
							BlockState _bs = world.getBlockState(_bp);
						...
						if ((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz)))).getBlock() == JishiBlock.block
								&& ((world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy + 1), (int) (z + sz)))).getBlock() == Blocks.AIR
										|| (world.getBlockState(new BlockPos((int) (x + sx), (int) (y + sy + 1), (int) (z + sz))))
												.getBlock() == Blocks.CAVE_AIR)) {
							world.setBlockState(new BlockPos((int) (x + sx), (int) (y + sy), (int) (z + sz)), MogudiBlock.block.getDefaultState(), 3);
						}
						sz = (sz + 1);
					}
					sy = (sy + 1);
		...
		if (new Object() {
			...
			if (world.getBlockState(new BlockPos((int) (x + 1), (int) y, (int) z)).isSolid()
					...
					&& world.getBlockState(new BlockPos((int) x, (int) y, (int) (z - 1))).isSolid() && Math.random() < 0.05) {
				...
				if ((world.getBlockState(new BlockPos((int) x, (int) (y + 1), (int) z))).getBlock() == Blocks.CAVE_AIR
					...
					world.setBlockState(new BlockPos((int) x, (int) y, (int) z), ShaojiaodesijizhiniBlock.block.getDefaultState(), 3);
					if (Math.random() < 0.3) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), Blocks.BROWN_MUSHROOM.getDefaultState(), 3);
						world.setBlockState(new BlockPos((int) x, (int) y, (int) z), ShaojiaodesijizhiniBlock.block.getDefaultState(), 3);
					}
					if (Math.random() < 0.3) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), Blocks.RED_MUSHROOM.getDefaultState(), 3);
						world.setBlockState(new BlockPos((int) x, (int) y, (int) z), ShaojiaodesijizhiniBlock.block.getDefaultState(), 3);
					}
					if (Math.random() < 0.4) {
					...
					if (Math.random() < 0.1) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), FaguangmoguBlock.block.getDefaultState(), 3);
						world.setBlockState(new BlockPos((int) x, (int) y, (int) z), ShaojiaodesijizhiniBlock.block.getDefaultState(), 3);
					}
					if (Math.random() < 0.45) {
						world.setBlockState(new BlockPos((int) x, (int) (y + 1), (int) z), Blocks.AIR.getDefaultState(), 3);
