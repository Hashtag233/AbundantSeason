...
import wwworld.item.XiajigushizhizhangItem;

import wwworld.entity.HuoYanLongJuanFengEntity;
...
public class HuoyanjitanGengXinYouXiKeProcedure {

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("world") == null) {
			if (!dependencies.containsKey("world"))
				WwworldMod.LOGGER.warn("Failed to load dependency world for procedure HuoyanjitanGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				WwworldMod.LOGGER.warn("Failed to load dependency x for procedure HuoyanjitanGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				WwworldMod.LOGGER.warn("Failed to load dependency y for procedure HuoyanjitanGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				WwworldMod.LOGGER.warn("Failed to load dependency z for procedure HuoyanjitanGengXinYouXiKe!");
			return;
		}
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				WwworldMod.LOGGER.warn("Failed to load dependency entity for procedure HuoyanjitanGengXinYouXiKe!");
			return;
		}
		...
		if (((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem() == XiajigushizhizhangItem.block && !(new Object() {
			...
			if (!((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).abilities.isCreativeMode : false)) {
				if (entity instanceof LivingEntity) {
					ItemStack _setstack = new ItemStack(XiajigushizhizhangItem.block);
					_setstack.setCount(
			...
			new Object() {
				...
				private void run() {
					...
					if (world instanceof ServerWorld) {
						Entity entityToSpawn = new HuoYanLongJuanFengEntity.CustomEntity(HuoYanLongJuanFengEntity.entity, (World) world);
						entityToSpawn.setLocationAndAngles(Math.floor(x), y, Math.floor(z), world.getRandom().nextFloat() * 360F, 0);
					...
					if (world instanceof ServerWorld) {
						Entity entityToSpawn = new HuoYanLongJuanFengEntity.CustomEntity(HuoYanLongJuanFengEntity.entity, (World) world);
						entityToSpawn.setLocationAndAngles(Math.floor(x), (y + 2), Math.floor(z), world.getRandom().nextFloat() * 360F, 0);
						if (entityToSpawn instanceof MobEntity)
							((MobEntity) entityToSpawn).onInitialSpawn((ServerWorld) world,
									world.getDifficultyForLocation(entityToSpawn.getPosition()), SpawnReason.MOB_SUMMONED, (ILivingEntityData) null,
									(CompoundNBT) null);
					...
					if (world instanceof ServerWorld) {
						Entity entityToSpawn = new HuoYanLongJuanFengEntity.CustomEntity(HuoYanLongJuanFengEntity.entity, (World) world);
						entityToSpawn.setLocationAndAngles(Math.floor(x), (y + 4), Math.floor(z), world.getRandom().nextFloat() * 360F, 0);
						if (entityToSpawn instanceof MobEntity)
							((MobEntity) entityToSpawn).onInitialSpawn((ServerWorld) world,
									world.getDifficultyForLocation(entityToSpawn.getPosition()), SpawnReason.MOB_SUMMONED, (ILivingEntityData) null,
									(CompoundNBT) null);
