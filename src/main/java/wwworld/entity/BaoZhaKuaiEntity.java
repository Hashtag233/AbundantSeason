...
import wwworld.procedures.BaoZhaKuaiDangShiTiGengXinKeShiProcedure;

import wwworld.entity.renderer.BaoZhaKuaiRenderer;
...
public class BaoZhaKuaiEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 0.5f)).build("bao_zha_kuai").setRegistryName("bao_zha_kuai");

	public BaoZhaKuaiEntity(WwworldModElements instance) {
		super(instance, 311);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			BaoZhaKuaiDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
