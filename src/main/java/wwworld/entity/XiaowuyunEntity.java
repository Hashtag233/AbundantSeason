...
import wwworld.procedures.XiaowuyunDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure;

import wwworld.entity.renderer.XiaowuyunRenderer;
...
public class XiaowuyunEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.8f, 0.2f)).build("xiaowuyun").setRegistryName("xiaowuyun");

	public XiaowuyunEntity(WwworldModElements instance) {
		super(instance, 312);
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.CREATURE).add(new MobSpawnInfo.Spawners(entity, 25, 2, 3));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			XiaowuyunDangWanJiaYuGaiShiTiFaShengPengZhuangShiProcedure.executeProcedure(Stream
