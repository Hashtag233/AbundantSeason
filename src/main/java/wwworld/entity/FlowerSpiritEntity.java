...
import wwworld.entity.renderer.FlowerSpiritRenderer;
...
public class FlowerSpiritEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 0.5f)).build("flower_spirit").setRegistryName("flower_spirit");

	public FlowerSpiritEntity(WwworldModElements instance) {
		super(instance, 303);
