...
import wwworld.procedures.XixuechongDangZheGeShiTiShaSiLingGeShiTiProcedure;
import wwworld.procedures.XixuechongDangShiTiShouShangShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.item.QiuyinItem;

import wwworld.entity.renderer.XixuechongRenderer;
...
public class XixuechongEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 0.4f)).build("xixuechong").setRegistryName("xixuechong");

	public XixuechongEntity(WwworldModElements instance) {
		super(instance, 316);
		FMLJavaModLoadingContext.get().getModEventBus().register(new XixuechongRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -5830905, -9305066, new Item.Properties().group(DddItemGroup.tab))
				.setRegistryName("xixuechong_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			XixuechongDangShiTiShouShangShiProcedure.executeProcedure(Stream
		...
		public void awardKillScore(Entity entity, int score, DamageSource damageSource) {
			...
			XixuechongDangZheGeShiTiShaSiLingGeShiTiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
