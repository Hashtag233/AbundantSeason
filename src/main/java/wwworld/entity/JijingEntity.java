...
import wwworld.procedures.JijingShiTiSiWangShiProcedure;

import wwworld.entity.renderer.JijingRenderer;
...
public class JijingEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(1.1f, 2.3f)).build("jijing").setRegistryName("jijing");

	public JijingEntity(WwworldModElements instance) {
		super(instance, 304);
		FMLJavaModLoadingContext.get().getModEventBus().register(new JijingRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			JijingShiTiSiWangShiProcedure.executeProcedure(Stream
