...
import wwworld.entity.renderer.LinghunkulouRenderer;
...
public class LinghunkulouEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.AMBIENT)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.5f)).build("linghunkulou").setRegistryName("linghunkulou");

	public LinghunkulouEntity(WwworldModElements instance) {
		super(instance, 317);
		FMLJavaModLoadingContext.get().getModEventBus().register(new LinghunkulouRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10066330, -3355444, new Item.Properties().group(DddItemGroup.tab))
				.setRegistryName("linghunkulou_spawn_egg"));
	}
