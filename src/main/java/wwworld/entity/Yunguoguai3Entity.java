...
import wwworld.procedures.Yunguoguai3DangYouJianDianJiShiTiProcedure;

import wwworld.item.YunduosuipianItem;

import wwworld.entity.renderer.Yunguoguai3Renderer;
...
public class Yunguoguai3Entity extends WwworldModElements.ModElement {
	...
	public Yunguoguai3Entity(WwworldModElements instance) {
		super(instance, 300);
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			Yunguoguai3DangYouJianDianJiShiTiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
