...
import wwworld.entity.renderer.VineFlowerRenderer;
...
public class VineFlowerEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.4f, 1.5f)).build("vine_flower").setRegistryName("vine_flower");

	public VineFlowerEntity(WwworldModElements instance) {
		super(instance, 307);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public void attackEntityWithRangedAttack(LivingEntity target, float flval) {
			TengManHuaZiDanItem.shoot(this, target);
		}
	}
}
