...
import wwworld.procedures.VineQueenDangShiTiSiWangShiProcedure;
import wwworld.procedures.VineQueenDangShiTiShouShangShiProcedure;
import wwworld.procedures.VineQueenDangShiTiGengXinKeShiProcedure;
import wwworld.procedures.VineQueenChuShiShiTiShengChengProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.VineQueenRenderer;
...
public class VineQueenEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1.4f)).build("vine_queen").setRegistryName("vine_queen");

	public VineQueenEntity(WwworldModElements instance) {
		super(instance, 281);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13408768, -13382656, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, QieEntity.CustomEntity.class, true, false));
		}
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			VineQueenDangShiTiShouShangShiProcedure.executeProcedure(Stream
		...
		public void onDeath(DamageSource source) {
			...
			VineQueenDangShiTiSiWangShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z), new AbstractMap.SimpleEntry<>("sourceentity", sourceentity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			VineQueenChuShiShiTiShengChengProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
		...
		public void baseTick() {
			...
			VineQueenDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
