...
import wwworld.procedures.SongshuShiTiSiWangShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.item.SongguoItem;

import wwworld.entity.renderer.SongshuRenderer;
...
public class SongshuEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 0.5f)).build("songshu").setRegistryName("songshu");

	public SongshuEntity(WwworldModElements instance) {
		super(instance, 289);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8962814, -6993408, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(2, new FollowOwnerGoal(this, 1, (float) 3, (float) 5, false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:danxiaodesongshu"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			SongshuShiTiSiWangShiProcedure.executeProcedure(Stream
