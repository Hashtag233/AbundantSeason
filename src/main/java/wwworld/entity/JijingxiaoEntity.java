...
import wwworld.procedures.JijingxiaoShiTiSiWangShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.JijingxiaoRenderer;
...
public class JijingxiaoEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.5f, 0.7f)).build("jijingxiao").setRegistryName("jijingxiao");

	public JijingxiaoEntity(WwworldModElements instance) {
		super(instance, 292);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -39322, -26215, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			JijingxiaoShiTiSiWangShiProcedure.executeProcedure(Stream
