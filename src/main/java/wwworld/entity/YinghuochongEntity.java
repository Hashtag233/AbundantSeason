...
import wwworld.procedures.YinghuochongShiTiSiWangShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.YinghuochongRenderer;
...
public class YinghuochongEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.8f, 0.8f)).build("yinghuochong").setRegistryName("yinghuochong");

	public YinghuochongEntity(WwworldModElements instance) {
		super(instance, 290);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -103, -256, new Item.Properties().group(DddItemGroup.tab)).setRegistryName("yinghuochong_spawn_egg"));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			YinghuochongShiTiSiWangShiProcedure.executeProcedure(Stream
