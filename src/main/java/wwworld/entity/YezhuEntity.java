...
import wwworld.procedures.YezhuShiTiSiWangShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.YezhuRenderer;
...
public class YezhuEntity extends WwworldModElements.ModElement {
	...
	public YezhuEntity(WwworldModElements instance) {
		super(instance, 288);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -6737152, -10079488, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:yezhu"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			YezhuShiTiSiWangShiProcedure.executeProcedure(Stream
