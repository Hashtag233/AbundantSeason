...
import wwworld.procedures.JiebaozheDangShiTiSiWangShiProcedure;
import wwworld.procedures.JiebaozheDangShiTiGengXinKeShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.JiebaozheRenderer;
...
public class JiebaozheEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(0.8f, 2f))
					.build("jiebaozhe").setRegistryName("jiebaozhe");

	public JiebaozheEntity(WwworldModElements instance) {
		super(instance, 296);
		FMLJavaModLoadingContext.get().getModEventBus().register(new JiebaozheRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8958714, -2961516, new Item.Properties().group(DddItemGroup.tab))
				.setRegistryName("jiebaozhe_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, QieEntity.CustomEntity.class, false, false));
			this.targetSelector.addGoal(7, new NearestAttackableTargetGoal(this, XiyouqieEntity.CustomEntity.class, false, false));
		}
		...
		public void onDeath(DamageSource source) {
			...
			JiebaozheDangShiTiSiWangShiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			JiebaozheDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
