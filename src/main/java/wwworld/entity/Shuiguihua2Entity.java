...
import wwworld.entity.renderer.Shuiguihua2Renderer;
...
public class Shuiguihua2Entity extends WwworldModElements.ModElement {
	...
	public Shuiguihua2Entity(WwworldModElements instance) {
		super(instance, 314);
