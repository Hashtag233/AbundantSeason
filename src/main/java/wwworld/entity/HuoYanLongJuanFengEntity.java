...
import wwworld.procedures.HuoYanLongJuanFengDangShiTiSiWangShiProcedure;
import wwworld.procedures.HuoYanLongJuanFengDangShiTiGengXinKeShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.HuoYanLongJuanFengRenderer;
...
public class HuoYanLongJuanFengEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(1.5f, 1.5f)).build("huo_yan_long_juan_feng").setRegistryName("huo_yan_long_juan_feng");

	public HuoYanLongJuanFengEntity(WwworldModElements instance) {
		super(instance, 282);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -9763065, -5733758, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			HuoYanLongJuanFengDangShiTiSiWangShiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			HuoYanLongJuanFengDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
