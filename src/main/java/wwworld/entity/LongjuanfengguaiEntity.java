...
import wwworld.procedures.ZongsemoguguaiZiRanShiTiShengChengTiaoJianProcedure;
import wwworld.procedures.LongjuanfengguaiShiTiSiWangShiProcedure;
import wwworld.procedures.LongjuanfengguaiDangWanJiaYuGaiShiTiXiangZhuangShiProcedure;
import wwworld.procedures.LongjuanfengguaiDangShiTiGengXinKeShiProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.LongjuanfengguaiRenderer;
...
public class LongjuanfengguaiEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1f, 2f)).build("longjuanfengguai").setRegistryName("longjuanfengguai");

	public LongjuanfengguaiEntity(WwworldModElements instance) {
		super(instance, 293);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -8553091, -9737365, new Item.Properties().group(DddItemGroup.tab))
	...
	public void init(FMLCommonSetupEvent event) {
		EntitySpawnPlacementRegistry.register(entity, EntitySpawnPlacementRegistry.PlacementType.ON_GROUND, Heightmap.Type.MOTION_BLOCKING_NO_LEAVES,
				(entityType, world, reason, pos, random) -> {
					...
					int y = pos.getY();
					int z = pos.getZ();
					return ZongsemoguguaiZiRanShiTiShengChengTiaoJianProcedure.executeProcedure(Stream
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			LongjuanfengguaiShiTiSiWangShiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			LongjuanfengguaiDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			LongjuanfengguaiDangWanJiaYuGaiShiTiXiangZhuangShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
