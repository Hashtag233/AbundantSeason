...
@OnlyIn(Dist.CLIENT)
public class QieRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(QieEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelqie(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wwworld:textures/zuizhongqi.png");
					}
				};
			});
		}
