...
@OnlyIn(Dist.CLIENT)
public class Yunguoguai4Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Yunguoguai4Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelyunguoguai4(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wwworld:textures/yunguoguai4.png");
					}
				};
			});
		}
	...
	public static class Modelyunguoguai4 extends EntityModel<Entity> {
		private final ModelRenderer bone;
		private final ModelRenderer bone2;
		private final ModelRenderer piao;

		public Modelyunguoguai4() {
			textureWidth = 128;
			textureHeight = 128;
			bone = new ModelRenderer(this);
			bone.setRotationPoint(0.0F, 28.0F, 0.0F);
			setRotationAngle(bone, 0.0F, 3.1416F, 0.0F);
			bone.setTextureOffset(77, 16).addBox(-4.0F, -26.0F, -4.0F, 8.0F, 5.0F, 1.0F, 0.0F, false);
			bone.setTextureOffset(78, 16).addBox(3.0F, -26.0F, -3.0F, 1.0F, 5.0F, 6.0F, 0.0F, false);
			...
			bone.setTextureOffset(81, 16).addBox(-4.0F, -26.0F, -3.0F, 1.0F, 5.0F, 6.0F, 0.0F, false);
