...
@OnlyIn(Dist.CLIENT)
public class Yunguoguai3Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Yunguoguai3Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelyunguoguai3(), 0.5f) {
