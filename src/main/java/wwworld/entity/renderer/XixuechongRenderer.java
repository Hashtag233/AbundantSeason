...
@OnlyIn(Dist.CLIENT)
public class XixuechongRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(XixuechongEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelleech(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wwworld:textures/leech.png");
					}
				};
			});
		}
