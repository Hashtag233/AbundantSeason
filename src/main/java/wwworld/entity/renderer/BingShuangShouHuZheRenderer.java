...
@OnlyIn(Dist.CLIENT)
public class BingShuangShouHuZheRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(BingShuangShouHuZheEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelbingshuangshouhuzhe(), 1f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wwworld:textures/bingshuangshouhuzhe.png");
					}
				};
			});
		}
