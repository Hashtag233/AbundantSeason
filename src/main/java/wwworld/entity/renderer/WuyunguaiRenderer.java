...
@OnlyIn(Dist.CLIENT)
public class WuyunguaiRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(WuyunguaiEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwuyunguai(), 0.6f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("wwworld:textures/wuyunguai.png");
					}
				};
			});
		}
