...
import wwworld.procedures.BingshuangliehunDangShiTiGengXinKeShiProcedure;

import wwworld.entity.renderer.BingshuangliehunRenderer;
...
public class BingshuangliehunEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(1f, 1.7f))
					.build("bingshuangliehun").setRegistryName("bingshuangliehun");

	public BingshuangliehunEntity(WwworldModElements instance) {
		super(instance, 310);
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void baseTick() {
			...
			BingshuangliehunDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
