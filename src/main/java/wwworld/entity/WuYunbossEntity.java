...
import wwworld.procedures.WuyunguaiDangWanJiaYuGaiShiTiXiangZhuangShiProcedure;
import wwworld.procedures.WuYunbossDangShiTiSiWangShiProcedure;
import wwworld.procedures.WuYunbossDangShiTiGengXinKeShiProcedure;

import wwworld.particle.HuiseliziParticle;

import wwworld.itemgroup.DddItemGroup;

import wwworld.item.Leimingfazhang2Item;

import wwworld.entity.renderer.WuYunbossRenderer;
...
public class WuYunbossEntity extends WwworldModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(3f, 3f)).build("wu_yunboss").setRegistryName("wu_yunboss");

	public WuYunbossEntity(WwworldModElements instance) {
		super(instance, 283);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(DddItemGroup.tab))
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		protected void registerGoals() {
			...
			this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, QieEntity.CustomEntity.class, false, false));
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:kuangleiwuyun"));
		}
		...
		public void onDeath(DamageSource source) {
			...
			WuYunbossDangShiTiSiWangShiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			WuYunbossDangShiTiGengXinKeShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			WuyunguaiDangWanJiaYuGaiShiTiXiangZhuangShiProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
