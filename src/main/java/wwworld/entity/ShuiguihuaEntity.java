...
import wwworld.procedures.ShuiguihuaDangYouJianDianJiShiTiProcedure;
import wwworld.procedures.ShuiguihuaDangWanJiaYuGaiShiTiXiangZhuangShiProcedure;
import wwworld.procedures.ShuiguihuaDangShiTiGengXinKeShiProcedure;
import wwworld.procedures.ShuiguihuaChuShiShiTiShengChengProcedure;

import wwworld.itemgroup.DddItemGroup;

import wwworld.entity.renderer.ShuiguihuaRenderer;
...
public class ShuiguihuaEntity extends WwworldModElements.ModElement {
	...
	public ShuiguihuaEntity(WwworldModElements instance) {
		super(instance, 285);
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16751053, -437301, new Item.Properties().group(DddItemGroup.tab))
	...
	public void addFeatureToBiomes(BiomeLoadingEvent event) {
		...
		if (new ResourceLocation("wwworld:fan_mao_yi_lin").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("wwworld:han_chao_lin").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("wwworld:feng_lin").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("wwworld:mo_gu_lin").equals(event.getName()))
			biomeCriteria = true;
		if (new ResourceLocation("wwworld:zhui_luo_tian_kong").equals(event.getName()))
			biomeCriteria = true;
		if (!biomeCriteria)
			return;
		event.getSpawns().getSpawner(EntityClassification.WATER_CREATURE).add(new MobSpawnInfo.Spawners(entity, 100, 1, 1));
	}
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public net.minecraft.util.SoundEvent getAmbientSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:shuiguihua"));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			ShuiguihuaChuShiShiTiShengChengProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
		...
		public ActionResultType func_230254_b_(PlayerEntity sourceentity, Hand hand) {
			...
			ShuiguihuaDangYouJianDianJiShiTiProcedure.executeProcedure(Stream
		...
		public void baseTick() {
			...
			ShuiguihuaDangShiTiGengXinKeShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			ShuiguihuaDangWanJiaYuGaiShiTiXiangZhuangShiProcedure.executeProcedure(Stream
