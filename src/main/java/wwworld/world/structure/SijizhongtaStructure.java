...
public class SijizhongtaStructure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 2500) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("wwworld", "sijizhongta"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("sijizhongta"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:sijizhongta"), configuredFeature);
		}
	}
