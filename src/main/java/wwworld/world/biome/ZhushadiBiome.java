...
public class ZhushadiBiome extends WwworldModElements.ModElement {
	public static Biome biome;

	public ZhushadiBiome(WwworldModElements instance) {
		super(instance, 864);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(HuishaBlock.block.getDefaultState(),
								HuishaBlock.block.getDefaultState(), HuishaBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("wwworld:zhu_sha_di"));
			}
		}
	}
