...
import wwworld.block.ZhiyeyanBlock;
...
public class PutongxiajiqunxiBiome extends WwworldModElements.ModElement {
	public static Biome biome;

	public PutongxiajiqunxiBiome(WwworldModElements instance) {
		super(instance, 400);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6868430).setWaterColor(-52429).setWaterFogColor(-52429)
						.withSkyColor(-6868430).withFoliageColor(-16777216).withGrassColor(-52429)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:xia")), 12000,
								24000, true))
						.build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ZhiyeyanBlock.block.getDefaultState(),
								ZhiyeyanBlock.block.getDefaultState(), ZhiyeyanBlock.block.getDefaultState())));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(ZhiyeyanBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.CREATURE, new MobSpawnInfo.Spawners(EntityType.MAGMA_CUBE, 19, 1, 3));
				...
				event.getRegistry().register(biome.setRegistryName("wwworld:huo_shan_di_dai"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("huo_shan_di_dai_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("huo_shan_di_dai_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("huo_shan_di_dai_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
