...
import wwworld.particle.YinghuayeParticle;

import wwworld.block.YingzhicaofangkuaiBlock;
...
public class YinghuayuanqunxiBiome extends WwworldModElements.ModElement {
	public static Biome biome;

	public YinghuayuanqunxiBiome(WwworldModElements instance) {
		super(instance, 755);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1059872).setWaterColor(-347694).setWaterFogColor(-347694)
						.withSkyColor(-1059872).withFoliageColor(-347694).withGrassColor(-347694)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:yinghua")), 12000,
								24000, true))
						.setParticle(new ParticleEffectAmbience(YinghuayeParticle.particle, 0.03f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(YingzhicaofangkuaiBlock.block.getDefaultState(),
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.SEAGRASS
						.withConfiguration(new ProbabilityConfig(0.3F)).func_242731_b(12).withPlacement(Features.Placements.SEAGRASS_DISK_PLACEMENT));
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION,
				...
				event.getRegistry().register(biome.setRegistryName("wwworld:ying_hua_yuan"));
			}
		}
	}
