...
public class XiajiBiome extends WwworldModElements.ModElement {
	public static Biome biome;

	public XiajiBiome(WwworldModElements instance) {
		super(instance, 397);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-474430).setWaterColor(-52429).setWaterFogColor(-52429)
						.withSkyColor(-474430).withFoliageColor(-39322).withGrassColor(-26215)
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ShaojiaodesijizhiniBlock.block.getDefaultState(),
								ShaojiaodenituBlock.block.getDefaultState(), ShaojiaodenituBlock.block.getDefaultState())));
				...
				event.getRegistry().register(biome.setRegistryName("wwworld:mo_gu_lin"));
			}
		}
	}
