...
import wwworld.particle.LuoyeParticle;
...
public class QiujiqunxiBiome extends WwworldModElements.ModElement {
	public static Biome biome;

	public QiujiqunxiBiome(WwworldModElements instance) {
		super(instance, 382);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-208460).setWaterColor(-39424).setWaterFogColor(-39424)
						.withSkyColor(-208460).withFoliageColor(-26317).withGrassColor(-39424)
						.setMusic(new BackgroundMusicSelector(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("wwworld:qiu")), 12000,
								24000, true))
						.setParticle(new ParticleEffectAmbience(LuoyeParticle.particle, 0.003f)).build();
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder().withSurfaceBuilder(
						SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(QiuzhicaofangkuaiBlock.block.getDefaultState(),
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(QiuzhicaofangkuaiBlock.block.getDefaultState(),
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.NONE).category(Biome.Category.NONE).depth(0f).scale(0.2f).temperature(0.4f)
						.downfall(0f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("wwworld:feng_lin"));
			}
		}
	}
