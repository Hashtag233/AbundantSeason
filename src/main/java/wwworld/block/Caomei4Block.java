...
import wwworld.procedures.Caomei3ZaiFangKuaiShangYouJianProcedure;
import wwworld.procedures.Caomei3DangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class Caomei4Block extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:caomei_4")
	public static final Block block = null;

	public Caomei4Block(WwworldModElements instance) {
		super(instance, 591);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("caomei_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:caomei_4"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(CaomeiItem.block));
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Caomei3DangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Caomei3ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
