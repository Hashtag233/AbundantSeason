...
public class YingzhizhalanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhizhalan")
	public static final Block block = null;

	public YingzhizhalanBlock(WwworldModElements instance) {
		super(instance, 69);
	}
