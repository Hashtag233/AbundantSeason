...
public class FuxiuzhiniBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuzhini")
	public static final Block block = null;

	public FuxiuzhiniBlock(WwworldModElements instance) {
		super(instance, 24);
	}
