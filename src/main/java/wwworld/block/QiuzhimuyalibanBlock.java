...
public class QiuzhimuyalibanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiuzhimuyaliban")
	public static final Block block = null;

	public QiuzhimuyalibanBlock(WwworldModElements instance) {
		super(instance, 92);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.75f, 2f)
					.setLightLevel(s -> 0).doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("qiuzhimuyaliban");
		}
