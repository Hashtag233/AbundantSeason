...
public class DongzhizhalanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhizhalan")
	public static final Block block = null;

	public DongzhizhalanBlock(WwworldModElements instance) {
		super(instance, 96);
	}
