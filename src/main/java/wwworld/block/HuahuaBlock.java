...
public class HuahuaBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:huahua")
	public static final Block block = null;

	public HuahuaBlock(WwworldModElements instance) {
		super(instance, 120);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:huahua"), configuredFeature);
		}
	}
