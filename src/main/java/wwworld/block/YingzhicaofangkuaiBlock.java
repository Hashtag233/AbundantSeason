...
public class YingzhicaofangkuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhicaofangkuai")
	public static final Block block = null;

	public YingzhicaofangkuaiBlock(WwworldModElements instance) {
		super(instance, 16);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("wwworld:yingzhicaofangkuai_match"),
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 20)).range(140)
					.square().func_242731_b(20);
			event.getRegistry().register(feature.setRegistryName("yingzhicaofangkuai"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:yingzhicaofangkuai"), configuredFeature);
		}
	}
