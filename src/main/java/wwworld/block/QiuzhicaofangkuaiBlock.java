...
public class QiuzhicaofangkuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiuzhicaofangkuai")
	public static final Block block = null;

	public QiuzhicaofangkuaiBlock(WwworldModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.GROUND).hardnessAndResistance(0.2f, 0.5f).setLightLevel(s -> 0));
