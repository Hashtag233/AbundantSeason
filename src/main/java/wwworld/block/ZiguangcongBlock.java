...
public class ZiguangcongBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:ziguangcong")
	public static final Block block = null;

	public ZiguangcongBlock(WwworldModElements instance) {
		super(instance, 118);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("ziguangcong"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:ziguangcong"), configuredFeature);
		}
	}
		...
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0,
					Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.PLANT).hardnessAndResistance(0f, 0f)
							.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setLightLevel(s -> 5));
			setRegistryName("ziguangcong");
		}
