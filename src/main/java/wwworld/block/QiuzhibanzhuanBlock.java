...
public class QiuzhibanzhuanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiuzhibanzhuan")
	public static final Block block = null;

	public QiuzhibanzhuanBlock(WwworldModElements instance) {
		super(instance, 86);
	}
