...
public class YingzhiloutiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhilouti")
	public static final Block block = null;

	public YingzhiloutiBlock(WwworldModElements instance) {
		super(instance, 67);
	}
