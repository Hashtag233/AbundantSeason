...
public class HuiyanqiangBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:huiyanqiang")
	public static final Block block = null;

	public HuiyanqiangBlock(WwworldModElements instance) {
		super(instance, 113);
	}
