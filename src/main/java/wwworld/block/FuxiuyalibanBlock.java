...
public class FuxiuyalibanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuyaliban")
	public static final Block block = null;

	public FuxiuyalibanBlock(WwworldModElements instance) {
		super(instance, 56);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.EVERYTHING,
					Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(1.5f, 2f).setLightLevel(s -> 0));
			setRegistryName("fuxiuyaliban");
		}
