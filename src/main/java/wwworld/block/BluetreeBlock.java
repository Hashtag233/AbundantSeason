...
public class BluetreeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bluetree")
	public static final Block block = null;

	public BluetreeBlock(WwworldModElements instance) {
		super(instance, 34);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 1f).setLightLevel(s -> 0));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("bluetree");
		}
