...
public class DongzhimubanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhimuban")
	public static final Block block = null;

	public DongzhimubanBlock(WwworldModElements instance) {
		super(instance, 93);
	}
