...
public class ShaojiaodesijizhiniBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shaojiaodesijizhini")
	public static final Block block = null;

	public ShaojiaodesijizhiniBlock(WwworldModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(3f, 0.5f).setLightLevel(s -> 0).harvestLevel(0)
