...
import wwworld.procedures.YunhuaDangShiTiZaiFangKuaiZhongPengZhuangShiProcedure;
...
public class Yunhua2Block extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yunhua_2")
	public static final Block block = null;

	public Yunhua2Block(WwworldModElements instance) {
		super(instance, 129);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:yunhua_2"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == YunkuaiBlock.block
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			YunhuaDangShiTiZaiFangKuaiZhongPengZhuangShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
