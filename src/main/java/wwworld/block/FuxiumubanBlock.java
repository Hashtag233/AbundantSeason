...
public class FuxiumubanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiumuban")
	public static final Block block = null;

	public FuxiumubanBlock(WwworldModElements instance) {
		super(instance, 48);
	}
