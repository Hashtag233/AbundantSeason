...
import wwworld.procedures.Xianggua4ZaiFangKuaiShangYouJianProcedure;
import wwworld.procedures.Xianggua4DangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class Xianggua5Block extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:xianggua_5")
	public static final Block block = null;

	public Xianggua5Block(WwworldModElements instance) {
		super(instance, 596);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:xianggua_5"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == QiuzhicaofangkuaiBlock.block
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Xianggua4DangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Xianggua4ZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
