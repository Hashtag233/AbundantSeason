...
import wwworld.item.CuaixinshiItem;
...
public class ShengmingkuangshiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shengmingkuangshi")
	public static final Block block = null;

	public ShengmingkuangshiBlock(WwworldModElements instance) {
		super(instance, 44);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("wwworld:shengmingkuangshi_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:shengmingkuangshi"), configuredFeature);
		}
	}
