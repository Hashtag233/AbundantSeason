...
public class YanzhimuanniuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhimuanniu")
	public static final Block block = null;

	public YanzhimuanniuBlock(WwworldModElements instance) {
		super(instance, 82);
	}
