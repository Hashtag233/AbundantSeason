...
import wwworld.procedures.FuxiuzhiyeDangWanJiaKaiShiPoPiShiProcedure;
import wwworld.procedures.FuxiuzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class FuxiuzhiyeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuzhiye")
	public static final Block block = null;

	public FuxiuzhiyeBlock(WwworldModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			FuxiuzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
		...
		public void onBlockClicked(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity) {
			...
			FuxiuzhiyeDangWanJiaKaiShiPoPiShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
	}
}
