...
public class FuxiuloutiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiulouti")
	public static final Block block = null;

	public FuxiuloutiBlock(WwworldModElements instance) {
		super(instance, 49);
	}
