...
import wwworld.procedures.JingyankuangshihtmlDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class JingyankuangshiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:jingyankuangshi")
	public static final Block block = null;

	public JingyankuangshiBlock(WwworldModElements instance) {
		super(instance, 40);
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			JingyankuangshihtmlDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("wwworld:jingyankuangshi_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:jingyankuangshi"), configuredFeature);
		}
	}
