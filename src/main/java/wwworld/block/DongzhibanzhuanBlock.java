...
public class DongzhibanzhuanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhibanzhuan")
	public static final Block block = null;

	public DongzhibanzhuanBlock(WwworldModElements instance) {
		super(instance, 95);
	}
