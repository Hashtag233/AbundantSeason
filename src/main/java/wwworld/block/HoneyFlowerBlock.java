...
import wwworld.procedures.FengmihuaZaiFangKuaiShangYouJianProcedure;
...
public class HoneyFlowerBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:honey_flower")
	public static final Block block = null;

	public HoneyFlowerBlock(WwworldModElements instance) {
		super(instance, 122);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("honey_flower"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:honey_flower"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			FengmihuaZaiFangKuaiShangYouJianProcedure.executeProcedure(Stream
