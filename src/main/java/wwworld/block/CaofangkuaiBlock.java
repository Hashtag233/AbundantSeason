...
public class CaofangkuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:caofangkuai")
	public static final Block block = null;

	public CaofangkuaiBlock(WwworldModElements instance) {
		super(instance, 15);
	}
