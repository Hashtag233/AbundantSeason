...
import wwworld.procedures.ZijuntiDangPiLinFangKuaiGengXinShiProcedure;
...
public class ZijuntiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:zijunti")
	public static final Block block = null;

	public ZijuntiBlock(WwworldModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.SPONGE).sound(SoundType.SLIME).hardnessAndResistance(1f, 1f).setLightLevel(s -> 12).notSolid()
					.setNeedsPostProcessing((bs, br, bp) -> true).setEmmisiveRendering((bs, br, bp) -> true).setOpaque((bs, br, bp) -> false));
			setRegistryName("zijunti");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			ZijuntiDangPiLinFangKuaiGengXinShiProcedure.executeProcedure(Stream
