...
public class ChunzhimuanniuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunzhimuanniu")
	public static final Block block = null;

	public ChunzhimuanniuBlock(WwworldModElements instance) {
		super(instance, 64);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("chunzhimuanniu");
		}
