...
public class ShaojiaodenituBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shaojiaodenitu")
	public static final Block block = null;

	public ShaojiaodenituBlock(WwworldModElements instance) {
		super(instance, 22);
	}
