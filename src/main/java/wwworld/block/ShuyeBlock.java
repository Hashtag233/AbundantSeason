...
import wwworld.procedures.ShuyehtmlDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class ShuyeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shuye")
	public static final Block block = null;

	public ShuyeBlock(WwworldModElements instance) {
		super(instance, 133);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ShuyehtmlDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
