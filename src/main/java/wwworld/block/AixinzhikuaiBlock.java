...
public class AixinzhikuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:aixinzhikuai")
	public static final Block block = null;

	public AixinzhikuaiBlock(WwworldModElements instance) {
		super(instance, 105);
	}
