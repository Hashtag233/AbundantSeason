...
public class FuxiuzhimuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuzhimu")
	public static final Block block = null;

	public FuxiuzhimuBlock(WwworldModElements instance) {
		super(instance, 28);
	}
