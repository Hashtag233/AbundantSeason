...
public class ChunzhimuyalibanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunzhimuyaliban")
	public static final Block block = null;

	public ChunzhimuyalibanBlock(WwworldModElements instance) {
		super(instance, 65);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("chunzhimuyaliban");
		}
