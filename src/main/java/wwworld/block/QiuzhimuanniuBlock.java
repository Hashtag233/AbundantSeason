...
public class QiuzhimuanniuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiuzhimuanniu")
	public static final Block block = null;

	public QiuzhimuanniuBlock(WwworldModElements instance) {
		super(instance, 91);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.75f, 2f).setLightLevel(s -> 0)
					.doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("qiuzhimuanniu");
		}
