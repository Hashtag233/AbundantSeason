...
import wwworld.procedures.HuoyanjitanGengXinYouXiKeProcedure;
...
public class HuoyanjitanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:huoyanjitan")
	public static final Block block = null;
	@ObjectHolder("wwworld:huoyanjitan")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;

	public HuoyanjitanBlock(WwworldModElements instance) {
		super(instance, 9);
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			HuoyanjitanGengXinYouXiKeProcedure.executeProcedure(Stream
