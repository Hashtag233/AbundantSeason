...
import wwworld.procedures.ZhirezhimuDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class ZhirezhimuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:zhirezhimu")
	public static final Block block = null;

	public ZhirezhimuBlock(WwworldModElements instance) {
		super(instance, 32);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(0.5f, 1f).setLightLevel(s -> 0));
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ZhirezhimuDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
