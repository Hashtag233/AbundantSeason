...
public class YingzhimuyalibanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhimuyaliban")
	public static final Block block = null;

	public YingzhimuyalibanBlock(WwworldModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("yingzhimuyaliban");
		}
