...
public class JishiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:jishi")
	public static final Block block = null;

	public JishiBlock(WwworldModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.GILDED_BLACKSTONE).hardnessAndResistance(1.25f, 6f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("jishi");
		}
