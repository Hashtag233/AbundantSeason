...
import wwworld.procedures.SijizhihuaFuJiaDeShengChengTiaoJianProcedure;
...
public class SijizhihuaBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:sijizhihua")
	public static final Block block = null;

	public SijizhihuaBlock(WwworldModElements instance) {
		super(instance, 115);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!SijizhihuaFuJiaDeShengChengTiaoJianProcedure.executeProcedure(Collections.EMPTY_MAP))
						return false;
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:sijizhihua"), configuredFeature);
		}
	}
