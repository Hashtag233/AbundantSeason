...
import wwworld.procedures.ShiduiDangZhiWuBeiWanJiaPoPiShiProcedure;
...
public class ShiduiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shidui")
	public static final Block block = null;

	public ShiduiBlock(WwworldModElements instance) {
		super(instance, 150);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:shidui"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.STONE)
					.hardnessAndResistance(0.3f, 0.1f).setLightLevel(s -> 1));
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(2, 0, 2, 14, 4, 14)
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ShiduiDangZhiWuBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
