...
public class ChunzhiloutiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunzhilouti")
	public static final Block block = null;

	public ChunzhiloutiBlock(WwworldModElements instance) {
		super(instance, 58);
	}
