...
public class CuaixinkuangBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:cuaixinkuang")
	public static final Block block = null;

	public CuaixinkuangBlock(WwworldModElements instance) {
		super(instance, 45);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("wwworld:cuaixinkuang_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:cuaixinkuang"), configuredFeature);
		}
	}
