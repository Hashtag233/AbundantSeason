...
public class HuijincaofangkuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:huijincaofangkuai")
	public static final Block block = null;

	public HuijincaofangkuaiBlock(WwworldModElements instance) {
		super(instance, 27);
	}
