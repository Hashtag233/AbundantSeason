...
public class YanzhizhalanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhizhalan")
	public static final Block block = null;

	public YanzhizhalanBlock(WwworldModElements instance) {
		super(instance, 78);
	}
