...
import wwworld.procedures.YingzhihuaFuJiaDeShengChengTiaoJianProcedure;
...
public class YingzhihuaBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhihua")
	public static final Block block = null;

	public YingzhihuaBlock(WwworldModElements instance) {
		super(instance, 123);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new DefaultFlowersFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!YingzhihuaFuJiaDeShengChengTiaoJianProcedure.executeProcedure(Stream
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:yingzhihua"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == YingzhicaofangkuaiBlock.block || ground == CaofangkuaiBlock.block
