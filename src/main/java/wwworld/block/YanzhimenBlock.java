...
public class YanzhimenBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhimen")
	public static final Block block = null;

	public YanzhimenBlock(WwworldModElements instance) {
		super(instance, 80);
	}
