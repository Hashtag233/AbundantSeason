...
public class ChunzhizhalanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunzhizhalan")
	public static final Block block = null;

	public ChunzhizhalanBlock(WwworldModElements instance) {
		super(instance, 60);
	}
