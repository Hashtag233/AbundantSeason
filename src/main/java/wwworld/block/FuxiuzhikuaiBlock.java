...
public class FuxiuzhikuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuzhikuai")
	public static final Block block = null;

	public FuxiuzhikuaiBlock(WwworldModElements instance) {
		super(instance, 4);
	}
