...
public class YunkuaiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yunkuai")
	public static final Block block = null;

	public YunkuaiBlock(WwworldModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.SNOW).hardnessAndResistance(3f, 0f).setLightLevel(s -> 0).harvestLevel(0)
