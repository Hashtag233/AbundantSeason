...
import wwworld.procedures.YanzhiyeDangWanJiaKaiShiPoPiShiProcedure;
import wwworld.procedures.YanzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class YanzhiyeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhiye")
	public static final Block block = null;

	public YanzhiyeBlock(WwworldModElements instance) {
		super(instance, 136);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			YanzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
		...
		public void onBlockClicked(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity) {
			...
			YanzhiyeDangWanJiaKaiShiPoPiShiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
