...
public class DongzhiloutiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhilouti")
	public static final Block block = null;

	public DongzhiloutiBlock(WwworldModElements instance) {
		super(instance, 94);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			super(() -> new Block(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f).setLightLevel(s -> 0)
					...
					Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f).setLightLevel(s -> 0).notSolid()
