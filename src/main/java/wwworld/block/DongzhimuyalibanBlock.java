...
public class DongzhimuyalibanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhimuyaliban")
	public static final Block block = null;

	public DongzhimuyalibanBlock(WwworldModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			super(Sensitivity.EVERYTHING, Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f)
					.setLightLevel(s -> 0).doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dongzhimuyaliban");
		}
