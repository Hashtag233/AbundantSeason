...
import wwworld.procedures.CaofangkuaiDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class NituBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:nitu")
	public static final Block block = null;

	public NituBlock(WwworldModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			CaofangkuaiDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
