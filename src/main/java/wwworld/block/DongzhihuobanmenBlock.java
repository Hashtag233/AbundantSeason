...
public class DongzhihuobanmenBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhihuobanmen")
	public static final Block block = null;

	public DongzhihuobanmenBlock(WwworldModElements instance) {
		super(instance, 99);
	}
