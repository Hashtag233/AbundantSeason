...
public class DongzhimuanniuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhimuanniu")
	public static final Block block = null;

	public DongzhimuanniuBlock(WwworldModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f).setLightLevel(s -> 0)
					.doesNotBlockMovement().notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dongzhimuanniu");
		}
