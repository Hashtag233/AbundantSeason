...
public class YanzhihuobanmenBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhihuobanmen")
	public static final Block block = null;

	public YanzhihuobanmenBlock(WwworldModElements instance) {
		super(instance, 81);
	}
	...
	public static class CustomBlock extends TrapDoorBlock {
		public CustomBlock() {
			...
			setRegistryName("yanzhihuobanmen");
		}
