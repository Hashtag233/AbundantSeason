...
public class YanzhizhalanmenBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhizhalanmen")
	public static final Block block = null;

	public YanzhizhalanmenBlock(WwworldModElements instance) {
		super(instance, 79);
	}
