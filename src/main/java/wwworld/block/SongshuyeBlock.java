...
import wwworld.procedures.SongshuyeDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class SongshuyeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:songshuye")
	public static final Block block = null;

	public SongshuyeBlock(WwworldModElements instance) {
		super(instance, 134);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			SongshuyeDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
