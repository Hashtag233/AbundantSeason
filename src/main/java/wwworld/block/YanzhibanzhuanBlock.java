...
public class YanzhibanzhuanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhibanzhuan")
	public static final Block block = null;

	public YanzhibanzhuanBlock(WwworldModElements instance) {
		super(instance, 77);
	}
