...
public class GaoziguangcongBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:gaoziguangcong")
	public static final Block block = null;

	public GaoziguangcongBlock(WwworldModElements instance) {
		super(instance, 119);
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new TallBlockItem(block, new Item.Properties().group(ZhuangtshixingItemGroup.tab)).setRegistryName(block.getRegistryName()));
	}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("gaoziguangcong"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:gaoziguangcong"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("gaoziguangcong");
		}
