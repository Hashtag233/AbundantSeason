...
import wwworld.procedures.BingxuezhihuaMobplayerCollidesWithPlantProcedure;
...
public class BingxuezhihuaBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bingxuezhihua")
	public static final Block block = null;

	public BingxuezhihuaBlock(WwworldModElements instance) {
		super(instance, 131);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:bingxuezhihua"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			BingxuezhihuaMobplayerCollidesWithPlantProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity))
