...
public class FuxiuzhalanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fuxiuzhalan")
	public static final Block block = null;

	public FuxiuzhalanBlock(WwworldModElements instance) {
		super(instance, 51);
	}
