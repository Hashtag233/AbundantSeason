...
import wwworld.procedures.YingzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure;
...
public class YingzhiyeBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhiye")
	public static final Block block = null;

	public YingzhiyeBlock(WwworldModElements instance) {
		super(instance, 135);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			YingzhiyeDangFangKuaiBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
