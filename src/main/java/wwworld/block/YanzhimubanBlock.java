...
public class YanzhimubanBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhimuban")
	public static final Block block = null;

	public YanzhimubanBlock(WwworldModElements instance) {
		super(instance, 75);
	}
