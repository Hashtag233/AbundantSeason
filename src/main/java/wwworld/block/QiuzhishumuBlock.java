...
public class QiuzhishumuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiuzhishumu")
	public static final Block block = null;

	public QiuzhishumuBlock(WwworldModElements instance) {
		super(instance, 33);
	}
