...
public class YingzhimuanniuBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhimuanniu")
	public static final Block block = null;

	public YingzhimuanniuBlock(WwworldModElements instance) {
		super(instance, 73);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("yingzhimuanniu");
		}
