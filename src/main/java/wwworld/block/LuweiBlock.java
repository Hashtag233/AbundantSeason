...
import wwworld.procedures.LuweiFuJiaDeShengChengTiaoJianProcedure;
import wwworld.procedures.LuweiDangZhiWuBeiWanJiaPoPiShiProcedure;
...
public class LuweiBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:luwei")
	public static final Block block = null;

	public LuweiBlock(WwworldModElements instance) {
		super(instance, 128);
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			feature = new RandomPatchFeature(BlockClusterFeatureConfig.field_236587_a_) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
					...
					int y = pos.getY();
					int z = pos.getZ();
					if (!LuweiFuJiaDeShengChengTiaoJianProcedure.executeProcedure(Stream
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("wwworld:luwei"), configuredFeature);
		}
	}
	...
	public static class BlockCustomFlower extends DoublePlantBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			LuweiDangZhiWuBeiWanJiaPoPiShiProcedure.executeProcedure(Stream
