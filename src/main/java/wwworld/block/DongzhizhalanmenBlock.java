...
public class DongzhizhalanmenBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhizhalanmen")
	public static final Block block = null;

	public DongzhizhalanmenBlock(WwworldModElements instance) {
		super(instance, 97);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(3f, 2f).setLightLevel(s -> 0).notSolid()
