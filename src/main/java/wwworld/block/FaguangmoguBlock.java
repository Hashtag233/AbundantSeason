...
import wwworld.procedures.FaguangmoguGengXinYouXiKeProcedure;

import wwworld.particle.YingguangmoguliziParticle;
...
public class FaguangmoguBlock extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:faguangmogu")
	public static final Block block = null;

	public FaguangmoguBlock(WwworldModElements instance) {
		super(instance, 126);
	}
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.PLANTS).sound(SoundType.PLANT).hardnessAndResistance(0.1f, 1f).setLightLevel(s -> 3)
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(3, 0, 3, 13, 12, 13)
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			FaguangmoguGengXinYouXiKeProcedure.executeProcedure(Stream
