...
import wwworld.procedures.TakefuxiuzhitaiProcedure;
import wwworld.procedures.OpenLingduan1Procedure;
import wwworld.procedures.FuxiuzhitaiGengXinYouXiKeProcedure;
...
public class FuxiuzhitaiguiGui extends WwworldModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public FuxiuzhitaiguiGui(WwworldModElements instance) {
		super(instance, 951);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("fuxiuzhitaigui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, FuxiuzhitaiguiGuiWindow::new));
	}
	...
	public void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.openContainer instanceof GuiContainerMod) {
			...
			FuxiuzhitaiGengXinYouXiKeProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 25, 53) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 43, 53) {
				@Override
				public void onSlotChanged() {
					super.onSlotChanged();
			...
			this.customSlots.put(10, this.addSlot(new SlotItemHandler(internal, 10, 124, 35) {
				@Override
	...
	static void handleButtonAction(PlayerEntity entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 0) {
			...
			OpenLingduan1Procedure.executeProcedure(Stream
	...
	private static void handleSlotAction(PlayerEntity entity, int slotID, int changeType, int meta, int x, int y, int z) {
		...
		if (slotID == 10 && changeType == 1) {
			...
			TakefuxiuzhitaiProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
					(_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
		}
	}
}
