...
public class QiujibaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiujibaoshi")
	public static final Item block = null;

	public QiujibaoshiItem(WwworldModElements instance) {
		super(instance, 165);
	}
