...
public class ShenshengxiangnagItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shenshengxiangnag")
	public static final Item block = null;

	public ShenshengxiangnagItem(WwworldModElements instance) {
		super(instance, 194);
	}
