...
public class DuciweipiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:duciweipi")
	public static final Item block = null;

	public DuciweipiItem(WwworldModElements instance) {
		super(instance, 216);
	}
