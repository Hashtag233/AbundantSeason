...
public class FengliItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fengli")
	public static final Item block = null;

	public FengliItem(WwworldModElements instance) {
		super(instance, 184);
	}
