...
public class HeianzhidingItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:heianzhiding")
	public static final Item block = null;

	public HeianzhidingItem(WwworldModElements instance) {
		super(instance, 170);
	}
