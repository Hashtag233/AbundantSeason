...
public class XiajibaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:xiajibaoshi")
	public static final Item block = null;

	public XiajibaoshiItem(WwworldModElements instance) {
		super(instance, 164);
	}
