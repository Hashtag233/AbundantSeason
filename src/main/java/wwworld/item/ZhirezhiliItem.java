...
public class ZhirezhiliItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:zhirezhili")
	public static final Item block = null;

	public ZhirezhiliItem(WwworldModElements instance) {
		super(instance, 183);
	}
