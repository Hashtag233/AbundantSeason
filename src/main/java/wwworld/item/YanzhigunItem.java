...
public class YanzhigunItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhigun")
	public static final Item block = null;

	public YanzhigunItem(WwworldModElements instance) {
		super(instance, 186);
	}
