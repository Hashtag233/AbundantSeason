...
public class DongxueyuItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongxueyu")
	public static final Item block = null;

	public DongxueyuItem(WwworldModElements instance) {
		super(instance, 222);
	}
