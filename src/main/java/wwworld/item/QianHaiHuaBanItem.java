...
public class QianHaiHuaBanItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qian_hai_hua_ban")
	public static final Item block = null;

	public QianHaiHuaBanItem(WwworldModElements instance) {
		super(instance, 195);
	}
