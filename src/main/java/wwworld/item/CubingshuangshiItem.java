...
public class CubingshuangshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:cubingshuangshi")
	public static final Item block = null;

	public CubingshuangshiItem(WwworldModElements instance) {
		super(instance, 179);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("cubingshuangshi");
		}
