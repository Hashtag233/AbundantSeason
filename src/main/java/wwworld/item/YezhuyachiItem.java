...
public class YezhuyachiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yezhuyachi")
	public static final Item block = null;

	public YezhuyachiItem(WwworldModElements instance) {
		super(instance, 214);
	}
