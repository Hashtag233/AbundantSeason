...
public class AixinzhidingItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:aixinzhiding")
	public static final Item block = null;

	public AixinzhidingItem(WwworldModElements instance) {
		super(instance, 171);
	}
