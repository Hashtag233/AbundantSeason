...
public class GenliufenItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:genliufen")
	public static final Item block = null;

	public GenliufenItem(WwworldModElements instance) {
		super(instance, 219);
	}
