...
public class ShiziItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:shizi")
	public static final Item block = null;

	public ShiziItem(WwworldModElements instance) {
		super(instance, 197);
	}
