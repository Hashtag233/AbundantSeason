...
public class YunduosuipianItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yunduosuipian")
	public static final Item block = null;

	public YunduosuipianItem(WwworldModElements instance) {
		super(instance, 199);
	}
