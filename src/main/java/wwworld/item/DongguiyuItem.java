...
public class DongguiyuItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongguiyu")
	public static final Item block = null;

	public DongguiyuItem(WwworldModElements instance) {
		super(instance, 221);
	}
