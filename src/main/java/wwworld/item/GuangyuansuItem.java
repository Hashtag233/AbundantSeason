...
public class GuangyuansuItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:guangyuansu")
	public static final Item block = null;

	public GuangyuansuItem(WwworldModElements instance) {
		super(instance, 204);
	}
