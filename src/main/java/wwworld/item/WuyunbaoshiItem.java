...
public class WuyunbaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:wuyunbaoshi")
	public static final Item block = null;

	public WuyunbaoshiItem(WwworldModElements instance) {
		super(instance, 206);
	}
