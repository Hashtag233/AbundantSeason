...
public class ChunjibaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunjibaoshi")
	public static final Item block = null;

	public ChunjibaoshiItem(WwworldModElements instance) {
		super(instance, 163);
	}
