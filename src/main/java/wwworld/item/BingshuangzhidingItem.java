...
public class BingshuangzhidingItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bingshuangzhiding")
	public static final Item block = null;

	public BingshuangzhidingItem(WwworldModElements instance) {
		super(instance, 176);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bingshuangzhiding");
		}
