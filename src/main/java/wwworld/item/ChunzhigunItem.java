...
public class ChunzhigunItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:chunzhigun")
	public static final Item block = null;

	public ChunzhigunItem(WwworldModElements instance) {
		super(instance, 185);
	}
