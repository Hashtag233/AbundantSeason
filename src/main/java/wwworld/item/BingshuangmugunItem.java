...
public class BingshuangmugunItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bingshuangmugun")
	public static final Item block = null;

	public BingshuangmugunItem(WwworldModElements instance) {
		super(instance, 188);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bingshuangmugun");
		}
