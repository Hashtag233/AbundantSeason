...
import wwworld.procedures.BingzhuiDangYouJianDianJiFangKuaiShiProcedure;
...
public class BingzhuiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bingzhui")
	public static final Item block = null;

	public BingzhuiItem(WwworldModElements instance) {
		super(instance, 220);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			BingzhuiDangYouJianDianJiFangKuaiShiProcedure.executeProcedure(Stream
