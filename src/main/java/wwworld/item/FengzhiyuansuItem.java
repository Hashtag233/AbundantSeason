...
public class FengzhiyuansuItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fengzhiyuansu")
	public static final Item block = null;

	public FengzhiyuansuItem(WwworldModElements instance) {
		super(instance, 205);
	}
