...
public class HongbaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:hongbaoshi")
	public static final Item block = null;

	public HongbaoshiItem(WwworldModElements instance) {
		super(instance, 169);
	}
