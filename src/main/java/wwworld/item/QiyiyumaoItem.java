...
public class QiyiyumaoItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:qiyiyumao")
	public static final Item block = null;

	public QiyiyumaoItem(WwworldModElements instance) {
		super(instance, 189);
	}
