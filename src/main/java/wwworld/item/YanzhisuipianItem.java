...
public class YanzhisuipianItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yanzhisuipian")
	public static final Item block = null;

	public YanzhisuipianItem(WwworldModElements instance) {
		super(instance, 196);
	}
