...
public class YingguangdingItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingguangding")
	public static final Item block = null;

	public YingguangdingItem(WwworldModElements instance) {
		super(instance, 173);
	}
