...
public class HuijinItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:huijin")
	public static final Item block = null;

	public HuijinItem(WwworldModElements instance) {
		super(instance, 201);
	}
