...
public class DongzhiyumaoItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:dongzhiyumao")
	public static final Item block = null;

	public DongzhiyumaoItem(WwworldModElements instance) {
		super(instance, 192);
	}
