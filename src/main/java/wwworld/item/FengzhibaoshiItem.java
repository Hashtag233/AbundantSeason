...
public class FengzhibaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fengzhibaoshi")
	public static final Item block = null;

	public FengzhibaoshiItem(WwworldModElements instance) {
		super(instance, 207);
	}
