...
public class MeitanliItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:meitanli")
	public static final Item block = null;

	public MeitanliItem(WwworldModElements instance) {
		super(instance, 198);
	}
