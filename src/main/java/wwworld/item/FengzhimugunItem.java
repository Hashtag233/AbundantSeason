...
public class FengzhimugunItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:fengzhimugun")
	public static final Item block = null;

	public FengzhimugunItem(WwworldModElements instance) {
		super(instance, 187);
	}
