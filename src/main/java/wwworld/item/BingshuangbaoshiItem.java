...
public class BingshuangbaoshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:bingshuangbaoshi")
	public static final Item block = null;

	public BingshuangbaoshiItem(WwworldModElements instance) {
		super(instance, 208);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("bingshuangbaoshi");
		}
