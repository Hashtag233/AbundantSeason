...
public class CuaixinshiItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:cuaixinshi")
	public static final Item block = null;

	public CuaixinshiItem(WwworldModElements instance) {
		super(instance, 178);
	}
