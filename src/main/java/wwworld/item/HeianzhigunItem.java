...
public class HeianzhigunItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:heianzhigun")
	public static final Item block = null;

	public HeianzhigunItem(WwworldModElements instance) {
		super(instance, 213);
	}
