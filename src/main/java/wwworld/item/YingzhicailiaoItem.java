...
public class YingzhicailiaoItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingzhicailiao")
	public static final Item block = null;

	public YingzhicailiaoItem(WwworldModElements instance) {
		super(instance, 193);
	}
