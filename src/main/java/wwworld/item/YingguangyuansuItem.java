...
public class YingguangyuansuItem extends WwworldModElements.ModElement {
	@ObjectHolder("wwworld:yingguangyuansu")
	public static final Item block = null;

	public YingguangyuansuItem(WwworldModElements instance) {
		super(instance, 203);
	}
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("yingguangyuansu");
		}
